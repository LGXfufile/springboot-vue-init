...
public class WXAIPhotoAPI {
    ...
    private final String AppKey = "203994817"; // 请注意了，AppKey和AppCode不是同一个东西
    private final String AppSecret = "Pucz3yNQrfTOOCnmhEHtpfYdFsRtSWyN";
...
//                Log.i(TAG, "checkServerTrusted");
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //输入文件地址
        String imageFileName = "C:\\Users\\A\\Desktop\\12\\121.jpg";
        ...
        // 证件照制作接口函数调用
        File dstFile = new File("您想要保存的结果图片路径");
